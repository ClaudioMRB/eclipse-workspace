...
import dio.digitalinnovation.academiaDeGinastica.services.AvaliacaoFisicaService;

@RestController
@RequestMapping(value = "/AvaliacoesFisicas")
public class AvaliacaoFisicaControllers {
 ...
 public ResponseEntity<AvaliacaoFisicaDto> findById(@PathVariable Long id) {
	 AvaliacaoFisicaDto findbyid = service.findById(id);
     return ResponseEntity.ok(findbyid);
 }

 @GetMapping /*Busca paginada de clientes*/
 public ResponseEntity<Page<AvaliacaoFisicaDto>> findAll(Pageable pageable) {
     Page<AvaliacaoFisicaDto> findAllDto = service.findAll(pageable);
     return ResponseEntity.ok(findAllDto);

 }

 @PostMapping /*Inserção de novo cliente*/
 public ResponseEntity<AvaliacaoFisicaDto> insert(@RequestBody AvaliacaoFisicaDto insertDto) throws URISyntaxException {
 ...
 public ResponseEntity<AvaliacaoFisicaDto> update(@PathVariable Long id, @RequestBody AvaliacaoFisicaDto updateDto) {
